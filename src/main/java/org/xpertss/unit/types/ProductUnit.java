 ...
 * <p/>
 * This class maintains the canonical form of this product (simplest form after factorization). For
 * example:
 * <code>METRE.pow(2).divide(METRE)</code> returns <code>METRE</code>.
 *
